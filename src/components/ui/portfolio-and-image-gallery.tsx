...
>( 
  ( 
    ...
    useGSAP( 
      () => { 
        ...
        if (!prefersReducedMotion) { 
          // Set initial state of children to be visible but scaled/rotated correctly by the parent li
          gsap.set(containerRef.current.children, { autoAlpha: 1, scale: 1 });
    ...
    return ( 
      <div 
        ref={mergedRef} 
        className={`min-h-[600px] w-full relative flex items-center justify-center overflow-hidden ${className}`} 
        {...rest} 
      > 
        <div 
